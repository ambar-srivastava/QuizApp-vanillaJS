...
function timeFunc() {
  ...
  if (time <= 0) {
    ...
    if (newDisplay != null) newDisplay.remove();
    createResultSection();
    time = 0;
  }
}
...
function createFrontPage() {
  ...
  p2.innerText =
    "Keep in mind that incorrect answers will penalize your scope time by ten seconds !";
...
function displayHighScores() {
  ...
  if (firstPg != null) firstPg.remove();
